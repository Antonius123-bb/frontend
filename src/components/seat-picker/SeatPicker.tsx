...
class SeatPicker extends React.Component<{seats: any, setCosts: any, setButton: any}, {seats: any, classes: any, cost: number, costList: any, selectedSeats: Array<number>}> {
    ...
    constructor(props: any) {
        ...
        this.state = {
            ...
            classes: this.props.seats.kategorien,
            cost: 0,
            costList: [],
            selectedSeats: []
        };
    ...
    render() {
        ...
        return (
            ...
            <div style={{'height': this.state.seats.height * 2, 'width': this.state.seats.width * 2, 'marginTop': '25px'}}>

                {
                    this.state.seats.sitze.map((seat, index) => {

                        const cat = this.state.classes.find(x => x.kategorieid === seat.kategorie);
